...
void Bullet::draw(Otherwise::SpriteBatch& spriteBatch)
{
    ...
    Otherwise::ColorRGBA8 color;
    color.r = 75;
    color.g = 75;
    color.b = 75;
    color.a = 255;

    spriteBatch.draw(destRect, uvRect, Otherwise::ResourceManager::getTexture("Textures/circle.png").id, 0.0f, color);
}
