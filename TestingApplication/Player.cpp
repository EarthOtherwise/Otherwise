...
void Player::init(float speed, glm::vec2 pos, Otherwise::InputManager* inputManager, Otherwise::Camera2D* camera, std::vector<Bullet>* bullets)
{
    _speed = speed;
    _position = pos;
    ...
    _color.a = 255;
    _health = 150;
    m_textureID = Otherwise::ResourceManager::getTexture("Textures/player.png").id;
}
