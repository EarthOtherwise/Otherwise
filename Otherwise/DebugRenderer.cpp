...
Otherwise::DebugRenderer::DebugRenderer() {
    // Empty
}
...
void Otherwise::DebugRenderer::init() {
...
void Otherwise::DebugRenderer::end() {
    glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
    // Orphan the buffer
...
void Otherwise::DebugRenderer::drawLine(const glm::vec2& a, const glm::vec2& b, const ColorRGBA8& color) {
    int i = m_verts.size();
...
void Otherwise::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGBA8& color, float angle) {
...
void Otherwise::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius) {
...
void Otherwise::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
    m_program.use();
...
void Otherwise::DebugRenderer::dispose() {
    if (m_vao) {
