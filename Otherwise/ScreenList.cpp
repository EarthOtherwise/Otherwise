...
namespace Otherwise
{
    ...
    IGameScreen* Otherwise::ScreenList::moveNext()
	{
    ...
    IGameScreen* Otherwise::ScreenList::movePrevious()
	{
        IGameScreen* currentScreen = getCurrent();
    ...
    void Otherwise::ScreenList::setScreen(int nextScreen)
	{
        m_currentScreenIndex = nextScreen;
    }

    void Otherwise::ScreenList::addScreen(IGameScreen* newScreen)
	{
    ...
    void Otherwise::ScreenList::destroy() 
	{
