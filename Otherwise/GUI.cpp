...
CEGUI::OpenGL3Renderer* Otherwise::GUI::m_renderer = nullptr;

void Otherwise::GUI::init(const std::string& resourceDirectory) {
...
void Otherwise::GUI::setMouseCursor(const std::string& imageFile) {
    m_context->getMouseCursor().setDefaultImage(imageFile);
}

void Otherwise::GUI::showMouseCursor() {
    m_context->getMouseCursor().show();
}

void Otherwise::GUI::hideMouseCursor() {
...
void Otherwise::GUI::onSDLEvent(SDL_Event& evnt) {
...
void Otherwise::GUI::loadScheme(const std::string& schemeFile) {
    CEGUI::SchemeManager::getSingleton().createFromFile(schemeFile);
}

CEGUI::Window* Otherwise::GUI::createWidget(const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
...
CEGUI::Window* Otherwise::GUI::createWidget(CEGUI::Window* parent, const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
    CEGUI::Window* newWindow = CEGUI::WindowManager::getSingleton().createWindow(type, name);
...
void Otherwise::GUI::setWidgetDestRect(CEGUI::Window* widget, const glm::vec4& destRectPerc, const glm::vec4& destRectPix) {
...
void Otherwise::GUI::setFont(const std::string& fontFile) {
